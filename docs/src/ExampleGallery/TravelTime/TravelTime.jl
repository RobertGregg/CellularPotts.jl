...
# Here r(t) represents the current position of the cell and the brackets indicate an average over time. If cell is moving randomly, this function will be linear. Cells with directional motion will deflect the curve upward. Let's see if we can replicate these theories. 
...
space = CellSpace(200,200; periodic=true, diagonal=true)
