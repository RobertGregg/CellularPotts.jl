...
<p style="text-align:center;">
    <img title="" src="https://github.com/RobertGregg/CellularPotts.jl/blob/master/Gallery/HelloWorld/HelloWorld.gif?raw=true" alt="Image of a light blue cell with fluctuating boundaries" width="445">
</p>
```
